...
namespace FlexConfirmMail.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   宛先が社内のみの場合は確認をスキップする に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   社内ドメイン・アドレス設定 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   注意が必要なドメイン・アドレス設定 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   社内ドメイン・アドレス に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   注意が必要なドメイン・アドレス に類似しているローカライズされた文字列を検索します。
        /// </summary>
